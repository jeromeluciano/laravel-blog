<x-layout>
    <div class="max-w-lg mx-auto bg-gray-100 p-8 rounded-xl border border-gray-200">
        <h1 class="text-center font-bold text-gray-700">Register</h1>
        <form method="post" action="/register" class="space-y-4">
            @csrf

            <div class="mb-2">
                <label for="name" class="block text-xs font-semibold text-gray-700 mb-2">Name</label>
                <input type="text" id="name" name="name" value="{{ old('name') }}" class="block w-full p-2 border border-gray-200 rounded-xl">
                @error('name')
